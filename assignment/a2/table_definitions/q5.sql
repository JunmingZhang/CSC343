...
DROP VIEW IF EXISTS PartyInCountry CASCADE;
DROP VIEW IF EXISTS AlliancePairs CASCADE;
DROP VIEW IF EXISTS numElections CASCADE;
DROP VIEW IF EXISTS AllianceResult CASCADE;
