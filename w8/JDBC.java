    ...
    public static void main(String args[]) throws IOException
        {
            ...
            try
            {
                ...
                System.out.println("What's the age you want to check? ");
                String age = br.readLine();

                // Insert that string into the PreparedStatement and execute it.
                ps.setDouble(1, Integer.parseInt(age));
                rs = ps.executeQuery();

                // Iterate through the result set and report on each tuple.
                while (rs.next()) {
                    double average = rs.getDouble("avg");
                    System.out.println("The average guess over the given age is: " + average);
                }
